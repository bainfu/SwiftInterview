...
struct PersonStruct {
    ...
    static func parse(dictionary: [String: Any]) -> PersonStruct {
        ...
        return PersonStruct(personId: personId, name: name, personDescription: desc, imageURL: imageURL, reviews: reviewArray)
    }
}
